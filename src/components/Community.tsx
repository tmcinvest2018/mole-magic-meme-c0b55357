      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            Race into the Degen Grand Prix Community
          </h2>
          <p className="text-gray-600 max-w-2xl mx-auto">
            DGP thrives because of its strong and passionate community of racers and crypto enthusiasts. Follow us on our social channels to stay updated and help shape the future of DGP.
          </p>
        </div>
        ...
        >
          <img
            ...
            alt="Degen Grand Prix Community"
